  ...
  return (
    <section className="agenda" id='agenda'>
      ...
      <div className="background-image-container-2">
        <img className="circuito-azul-2" src={width >= 1024 ? "/assets/images/desktop/circuito-agenda-desktop.png" : "/assets/images/mobile/circuito-azul-agenda-2-mobile.png"} alt="circuito azul" />
        <div className="canvas canvas-1" />
        <div className="canvas canvas-2" />
        <div className="canvas canvas-3" />
        <div className="canvas canvas-4" />
